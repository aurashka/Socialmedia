...
export const UserResultCard: React.FC<{user: User}> = ({ user }) => (
    <a href={`#/profile/${user.id}`} className="flex items-center space-x-4 p-3 hover:bg-gray-50 dark:hover:bg-[#262626] transition-colors">
...
export const CommunityResultCard: React.FC<{community: Community}> = ({ community }) => (
    <a href={`#/community/${community.id}`} className="flex items-center space-x-4 p-3 hover:bg-gray-50 dark:hover:bg-[#262626] transition-colors">
...
export const ChannelResultCard: React.FC<{channel: Channel}> = ({ channel }) => (
    <a href={`#/channel/${channel.id}`} className="flex items-center space-x-4 p-3 hover:bg-gray-50 dark:hover:bg-[#262626] transition-colors">
